...
const (
	...
	AgentServiceListAgentsProcedure = "/api.v1.AgentService/ListAgents"
)
...
func NewAgentServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AgentServiceClient {
	...
	agentServiceMethods := v1.File_proto_api_v1_agent_proto.Services().ByName("AgentService").Methods()
...
// ListAgents calls api.v1.AgentService.ListAgents.
...
func (UnimplementedAgentServiceHandler) ListAgents(context.Context, *connect.Request[v1.ListAgentsRequest]) (*connect.Response[v1.ListAgentsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.AgentService.ListAgents is not implemented"))
}
